				...
				<div class="geex-content__chat__sidebar">
					<div class="geex-content__chat__sidebar__searchform">
						<div class="geex-content__chat__sidebar__searchform__search">
							<input type="text" id="sidebarSearchInput1" placeholder="Search" class="geex-content__header__btn" />
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput2" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
								...
								<div class="geex-content__chat__header__content">
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput3" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
								...
								<div class="geex-content__chat__header__content">
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput4" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
								...
								<div class="geex-content__chat__header__content">
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput5" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
								...
								<div class="geex-content__chat__header__content">
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput6" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
								...
								<div class="geex-content__chat__header__content">
									...
									<ul class="geex-content__chat__header__filter">
										...
										<li>
											...
											<div class="geex-content__chat__header__filter__content geex-content__header__searchform">
												<input type="text" id="sidebarSearchInput7" placeholder="Search" class="geex-content__header__btn">
												<i class="uil uil-search"></i>
											</div>
										</li>
										<li>
