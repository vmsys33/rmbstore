    ...
    <div class="geex-header__wrapper">
        <div class="geex-header__logo-wrapper">
            <a href="<?= route_to('admin.home') ?>" class="geex-header__logo">
                <?php 
                $storeLogo = \App\Helpers\SettingsHelper::getStoreLogo();
                $storeName = \App\Helpers\SettingsHelper::getStoreName();
                ?>
                <?php if ($storeLogo): ?>
                    <img class="logo-lite" src="<?= base_url($storeLogo) ?>" alt="<?= esc($storeName) ?>" style="max-height: 40px;" />
                    <img class="logo-dark" src="<?= base_url($storeLogo) ?>" alt="<?= esc($storeName) ?>" style="max-height: 40px;" />
                <?php else: ?>
        ...
        <nav class="geex-header__menu-wrapper">
            <ul class="geex-header__menu">
                <li class="geex-header__menu__item has-children">
                    ...
                    <ul class="geex-header__submenu">
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('admin.home') ?>" class="geex-header__menu__link">Server Management</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('index2') ?>" class="geex-header__menu__link">Banking</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('index3') ?>" class="geex-header__menu__link">Crypto</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('index4') ?>" class="geex-header__menu__link">Invoicing</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="geex-header__menu__item has-children">
                    ...
                    <ul class="geex-header__submenu">
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('todo') ?>" class="geex-header__menu__link">Todo</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('chat') ?>" class="geex-header__menu__link">Chat</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('calender') ?>" class="geex-header__menu__link">Calendar</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="geex-header__menu__item has-children">
                    ...
                    <ul class="geex-header__submenu">
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('chart') ?>" class="geex-header__menu__link">Chart</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('badge') ?>" class="geex-header__menu__link">Badge</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('button') ?>" class="geex-header__menu__link">Button</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('color') ?>" class="geex-header__menu__link">Color</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('form') ?>" class="geex-header__menu__link">Form</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('icon') ?>" class="geex-header__menu__link">Icon</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('navigation') ?>" class="geex-header__menu__link">Navigation</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('typography') ?>" class="geex-header__menu__link">Typography</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="geex-header__menu__item has-children">
                    ...
                    <ul class="geex-header__submenu">
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('blog') ?>" class="geex-header__menu__link">Blog</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('faq') ?>" class="geex-header__menu__link">Faq</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('pricing') ?>" class="geex-header__menu__link">Pricing</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('testimonial') ?>" class="geex-header__menu__link">Testimonial</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('terms') ?>" class="geex-header__menu__link">Terms & Conditions</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('signin') ?>" class="geex-header__menu__link">Sign In</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('signup') ?>" class="geex-header__menu__link">Sign Up</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('forgetPassword') ?>" class="geex-header__menu__link">Forget Password</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('verification') ?>" class="geex-header__menu__link">Two Step Verification</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('error') ?>" class="geex-header__menu__link">Error</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('comingsoon') ?>" class="geex-header__menu__link">Coming Soon</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('maintenance') ?>" class="geex-header__menu__link">Maintenance</a>
                        </li>
                        <li class="geex-header__menu__item">
                            <a href="<?= route_to('blankpage') ?>" class="geex-header__menu__link">Blank Page</a>
                        </li>
                    </ul>
                </li>
            </ul>
