                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li><strong>ID:</strong> <span class="text-muted"><?= $user['id'] ?></span></li>
                                            <li><strong>Created:</strong> <span class="text-muted"><?= date('M d, Y H:i', strtotime($user['created_at'])) ?></span></li>
                                            <li><strong>Updated:</strong> <span class="text-muted"><?= date('M d, Y H:i', strtotime($user['updated_at'])) ?></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
