    ...
    <div class="geex-content__section-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Add a new slider for the frontend</p>
            </div>
            <div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="<?= route_to('sliders.store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control <?= session()->getFlashdata('errors.subtitle') ? 'is-invalid' : '' ?>" 
                                          ...
                                          name="subtitle" 
                                          rows="3" 
                                          placeholder="Enter slider subtitle"><?= old('subtitle') ?></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <?php endif; ?>
                                <div class="form-text">
                                    Recommended size: 1200x600 pixels. Supported formats: JPG, PNG, GIF.
                                </div>
                            </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="uil uil-save"></i> Create Slider
                        </button>
                    </div>
                </form>
            </div>
